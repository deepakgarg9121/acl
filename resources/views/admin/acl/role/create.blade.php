        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered"  data-parsley-validate="true"  method='post' action="{{route('role.store')}}">
                        {!! Form::token() !!}
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4">Role* :</label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" type="text" id="name" value='{{old("name")}}' name="name" data-type="alphanum" placeholder="Create Role" data-parsley-required="true" >
